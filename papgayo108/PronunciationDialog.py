...
class PronunciationDialog(wx.Dialog):
	def __init__(self, *args, **kwds):
		...
		global ID_TH; ID_TH = wx.NewId()
		
		self.button_12 = wx.Button(self, ID_TH, "TH")

		global ID_CH; ID_CH = wx.NewId()
		
		self.button_13 = wx.Button(self, ID_CH, "CH")
		...
		wx.EVT_BUTTON(self, ID_TH, self.OnTH)
		wx.EVT_BUTTON(self, ID_CH, self.OnCH)
	...
	def __do_layout(self):
		...
		grid_sizer_1 = wx.GridSizer(4, 4, 5, 5)
		...
		grid_sizer_1.Add(self.button_12, 0, wx.FIXED_MINSIZE, 0)
	
		grid_sizer_1.Add(self.button_13, 0, wx.FIXED_MINSIZE, 0)
